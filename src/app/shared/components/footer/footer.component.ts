                ...
                <div class="grid grid-cols-1 gap-8 md:grid-cols-4">
                    ...
                    <aside class="flex flex-col">
                        <div class="mb-4 flex items-center space-x-2">
                            <span class="text-2xl font-bold"> <span class="text-primary">Simple</span>Template </span>
                        </div>
                    ...
                    <nav class="flex flex-col">
                        ...
                        <div class="grid grid-flow-col gap-4">
                            <a class="link link-hover" title="LinkedIn">
                                ...
                                <svg class="hover:fill-primaryt h-6 w-6 fill-current transition-all duration-200 hover:scale-110" viewBox="0 0 24 24">
                                    <path
                            ...
                            <a class="link link-hover" title="GitHub">
                                <svg class="hover:fill-primary h-6 w-6 fill-current transition-all duration-200 hover:scale-110" viewBox="0 0 24 24">
                                    <path
